...
- (void)flashBtnClicked:(UIButton *)flashBtn{
    if (self.changeSwitchBlock) {
        ...
        self.changeSwitchBlock(self.flashOpen);
    }
}
...
- (UIButton *)flashBtn{
    if (_flashBtn == nil) {
        ...
        [_flashBtn setImage:[UIImage mt_imageNamed:@"scanFlashlight"] forState:UIControlStateNormal];
